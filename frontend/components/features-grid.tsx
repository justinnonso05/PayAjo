          ...
          <StaggerItem key={title}>
            <div className="group relative h-full overflow-hidden rounded-card border border-brand-dark/5 bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_20px_40px_rgba(29,49,8,0.15)]">
              ...
              <div className="relative">
                <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-brand-pale transition-colors duration-300 group-hover:bg-white/15">
                  <Icon size={20} className="text-brand-accent transition-colors duration-300 group-hover:text-brand" />
                </div>
                <h3 className="mt-5 font-display text-sm font-bold text-brand-dark transition-colors duration-300 group-hover:text-white">
                  {title}
                </h3>
                <p className="mt-2 text-xs leading-relaxed text-brand-dark/55 transition-colors duration-300 group-hover:text-white/70">
                  {desc}
                </p>
              </div>
            </div>
