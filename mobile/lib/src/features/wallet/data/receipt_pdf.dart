...
Future<void> shareReceiptPdf(TransactionReceipt receipt) async {
                  ...
                  pw.Row(
                    children: [
                      ...
                      pw.Column(
                        crossAxisAlignment: pw.CrossAxisAlignment.start,
                        children: [
                          pw.Text('PayAjo', style: pw.TextStyle(font: displayFont, fontSize: 18, color: _brandDark)),
            ...
            pw.Padding(
              ...
              child: pw.Column(
                ...
                children: [
                  ...
                  pw.Text(
                    'This receipt was generated by PayAjo and is valid without a signature.',
                    style: const pw.TextStyle(fontSize: 9, color: _muted),
                  ),
                ],
              ),
  ...
  await Printing.sharePdf(bytes: await doc.save(), filename: 'payajo-receipt-$idPrefix.pdf');
}
